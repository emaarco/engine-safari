...
/**
 * Configures the history cleanup job for the CIB Seven engine.
 * @see <a href="https://docs.cibseven.org/manual/2.0/user-guide/process-engine/history/history-cleanup/">History Cleanup</a>
 */
@Configuration
