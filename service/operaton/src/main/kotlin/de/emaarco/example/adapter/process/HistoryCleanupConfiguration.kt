...
/**
 * Configures the history cleanup job for the Operaton engine.
 * @see <a href="https://docs.operaton.org/docs/documentation/user-guide/process-engine/history/history-cleanup/">History Cleanup</a>
 */
@Configuration
